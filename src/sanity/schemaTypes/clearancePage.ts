...
export const clearancePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: 'page',
      description:
        'Note about the payment process. E.g. "Each item links directly to a secure Stripe checkout."',
    }),
    defineField({
      name: 'pickupNote',
      title: 'Pickup / shipping note',
      type: 'string',
      group: 'page',
      description:
        'Note about how the buyer receives the item. E.g. "Local pickup in St. Matthews, SC only."',
    }),
    defineField({
      name: 'soldOutLabel',
      title: '"Sold out" badge label',
      type: 'string',
      group: 'page',
      initialValue: 'Sold',
      validation: (R) => R.required(),
    ...
    defineField({
      ...
      description: 'Label on the Stripe payment link button.',
      validation: (R) => R.required(),
    }),
    defineField({
    ...
    defineField({
      ...
      title: 'Empty state — primary button label',
      type: 'string',
      group: 'page',
    ...
    defineField({
      ...
      title: 'Empty state — primary button destination',
      type: 'string',
      group: 'page',
    ...
    defineField({
      ...
      title: 'Empty state — secondary link label',
      type: 'string',
      group: 'page',
    ...
    defineField({
      ...
      title: 'Empty state — secondary link destination',
      type: 'string',
      group: 'page',
