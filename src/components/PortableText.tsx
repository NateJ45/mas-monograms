          ...
          <figure className={figClass}>
            ...
            {(value.decisionLine || value.caption) && (
              <figcaption className="mt-s px-m md:px-0">
                {value.decisionLine && (
                  <span className="mb-xs block text-xs tracking-eyebrow text-[var(--color-text-secondary)] uppercase">
                    {value.decisionLine}
                  </span>
                )}
                {value.caption && (
                  <span className="block text-sm leading-relaxed text-[var(--color-text-secondary)] italic md:text-base">
                    {value.caption}
                  </span>
                )}
              </figcaption>
