...
//
//   The client always reads through the API CDN, token or not (2026-09-23):
//   the API CDN has accepted authenticated requests since API version
//   2021-03-25, so there's no need to force the uncached API just because a
//   token is present. See the `useCdn` comment below for why this matters.
//
// Anon fallback:
