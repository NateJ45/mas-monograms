...
// grids only exist there). One test per route, resizing down without reload;
// the layouts are CSS-driven, so a resize exercises the same media queries a
// fresh load would, at a fraction of the runtime.
// =============================================================================
